...
const Home = () => {
  ...
  return (
    <>
      <MainLayout>
        {!isLoggedIn ? (
          <div className='bg-gradient-to-r from-indigo-600 from-30% via-sky-700 via-30% to-emerald-600 to-70% min-h-[667px] max-h-screenw-full text-white h-[40vh] py-8 text-center'>
