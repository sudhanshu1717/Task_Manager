...
const Navbar = () => {
  ...
  return (
    <>
      <header className='flex justify-between sticky top-0 p-4 bg-gradient-to-r from-indigo-800 from-30% via-sky-900 via-30% to-emerald-800 shadow-sm items-center'>
        ...
        <ul className='hidden md:flex gap-4 uppercase font-medium'>
          {authState.isLoggedIn ? (
            ...
            <li className='py-2 px-3 cursor-pointer text-white hover:bg-gray-700 transition rounded-sm'><Link to="/login">Login</Link></li>
          )}
        </ul>
